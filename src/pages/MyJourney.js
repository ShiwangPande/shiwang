    ...
    return (
        <div className=''>
            ...
            <div className='coloums-1 lg:columns-2 w-[100vw] mx-5 lg:mx-40 my-14 '>
                <div className=''>
                    ...
                    <div>
                        ...
                        <ol class="relative border-s border-[#00e6e6] dark:border-gray-700">
                            ...
                            <div class="absolute w-3 h-3 bg-[#00e6e6]  rounded-full mt-1.5 -start-1.5 border border-[#00e6e6] "></div>
                            <li class="mb-10 ms-4 max-w-xs	 lg:max-w-xl p-4 lg:p-6 bg-black/10 border border-[#00e6e6] bg-opacity-5 backdrop-blur-lg  rounded-lg shadow 0">
                                <h3 class="text-lg font-semibold text-white ">St. Paul Jr. College</h3>
                                <time class="mb-1 text-sm font-normal leading-none text-[#00e6e6] ">2019-2020</time>
                                <p class="mb-4 text-base font-normal text-gray-200 ">I completed my 11th and 12th grades at St. Paul Jr. College under the HSC Maharashtra State Board. I excelled academically, achieving a score of 91%. This strong performance in higher secondary education has laid a solid foundation for my future studies.</p>
                ...
                <div >
                    <h1 className='pb-5 text-3xl font-semibold'> Experience </h1>
                    <div>
                        ...
                        <ol class="relative border-s border-[#00e6e6] dark:border-gray-700">
                            ...
                            <div class="absolute w-3 h-3 bg-[#00e6e6]  rounded-full mt-1.5 -start-1.5 border border-[#00e6e6] "></div>
                            <li class="mb-10 ms-4 max-w-xs	 lg:max-w-xl p-4 lg:p-6 bg-black/10 border border-[#00e6e6] bg-opacity-5 backdrop-blur-lg  rounded-lg shadow 0">
                                <h3 class="text-lg font-semibold text-white ">Internship at CodeClause</h3>
                                <time class="mb-1 text-sm font-normal leading-none text-[#00e6e6] ">Intern as Artificial Intelligence | 1 April, 2023</time>
                                <p class="mb-4 text-base font-normal text-gray-200 ">
                                    <li>
                                        <p>My first task was to make a House Price Prediction App.</p>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <p>My 1st project:-
                                            <a href=" https://github.com/ShiwangPande/house-price-prediction" className='text-[#00e6e6]'> Link </a></p>
                                    </li>
                                    <li>
                                        <p>My 2nd project:-
                                            <a href="https://github.com/ShiwangPande/gold-price-prediction-app" className='text-[#00e6e6]'>  Link </a></p>
                                    </li>

                                </p>
                                <a href="https://www.linkedin.com/posts/shiwang-pandey_internship-completion-at-code-clause-activity-7060184179770015744-qZZ5?utm_source=combined_share_message&utm_medium=member_desktop" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-[#00e6e6] border border-[#00e6e6] rounded-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-gray-100 focus:text-blue-700 dark:bg-gray-800  dark:border-gray-600 dark:hover:text-[#00e6e6] dark:hover:bg-gray-700 dark:focus:ring-gray-700">Learn more <svg class="w-3 h-3 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
                                </svg></a>
                            </li>
                            <div class="absolute w-3 h-3 bg-[#00e6e6]  rounded-full mt-1.5 -start-1.5 border border-[#00e6e6] "></div>
